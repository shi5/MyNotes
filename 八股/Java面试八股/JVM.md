...
针对HotSpot虚拟机：
TLAB分配，即Thread Local Allocation Buffer。即预先给每个线程分配一小部分“私有内存”，线程在该“私有内存”可以创建对象，其他线程只能访问创建的对象

TLAB存在的问题：可能存在TLAB无法分配的大对象
![[Pasted image 20240531155936.png]]

**虚拟机定义了一个refill_waste的值，这个值可以翻译为“最大浪费空间”**：当请求分配的内存大于refill_waste的时候，则选择方案1；若小于refill_waste值，则选择方案2
